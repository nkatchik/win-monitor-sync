...
`monitor-sync.ico`: a white sun and two short sound arcs on a medium slate-grey
background (`#77899A`). The arcs open toward the shared centre and radiate toward the lower
