...
- Volume keys control monitor volume, with Windows at 100% after confirmed DDC readback and no app volume overlay. Brightness media keys control the screen under the cursor and show a Windows-style indicator; fixed shortcuts remain a fallback.
